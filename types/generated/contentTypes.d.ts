...
export interface ApiQuickstartQuickstart extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'quickstarts';
    singularName: 'quickstart';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiStaffOnboardingStaffOnboarding
  extends Struct.CollectionTypeSchema {
  collectionName: 'staff_onboardings';
  info: {
    displayName: 'Staff Onboarding';
    pluralName: 'staff-onboardings';
    singularName: 'staff-onboarding';
  };
  options: {
    draftAndPublish: true;
  };
